...
- Please prefer subagents and dynamic workflows (a skill / pi extension) when doing anything that's at all complicated (e.g. more than one file, requires exploration, etc).
